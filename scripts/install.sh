#!/usr/bin/env bash
# fundamentals-desk — install script (standard fleet template, S3-compliant)
set -euo pipefail

SRC="$(cd "$(dirname "$0")/.." && pwd)"
DEST="$HOME/.claude/skills/fundamentals-desk"
...
echo "✅ fundamentals-desk v$VERSION installed as symlink → $SRC"
